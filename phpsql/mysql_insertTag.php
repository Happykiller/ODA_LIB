...
//Liens de test
// phpsql/mysql_insertTag.php?milis=123450&ctrl=ok&id_livre=6&tag=php
...
//--------------------------------------------------------------------------
$strSql = "INSERT INTO `".$prefixTable."tab_tags` (`id_livre`,`tag`,`date_creation`) 
    VALUES 
    ('".$arrayValeur["id_livre"]."','".addSlashes($arrayValeur["tag"])."', NOW())
;";
