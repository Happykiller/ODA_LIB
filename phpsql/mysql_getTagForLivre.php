...
//Liens de test
// phpsql/mysql_getTagForLivre.php?milis=123450&ctrl=ok&id_livre=6&order=tag&orderSens=asc
...
$strFiltreId = "";
if($arrayValeur["id_livre"] != ""){
    $strFiltreId = "AND a.id_livre = ".$arrayValeur["id_livre"]."";
}

$strSql = "SELECT a.id,a.id_livre,a.tag
