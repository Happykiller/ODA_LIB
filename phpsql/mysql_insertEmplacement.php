...
//Liens de test
// phpsql/mysql_insertEmplacement.php?milis=123450&ctrl=ok&id_livre=6&emplacement=Second étage à droite.
...
$strSql = "INSERT INTO `".$prefixTable."tab_emplacement` (`id_livre`,`emplacement`,`date_creation`) 
VALUES 
('".$arrayValeur["id_livre"]."','".addSlashes($arrayValeur["emplacement"])."', NOW())
;";
